...
import { PUBLIC_REGISTRATION_ENABLED, ORGANIZATION_CONFIG } from '@shared/utils/config';
...
import { SocialAuthButton, AuthDivider } from '@shared/components/auth/SocialAuthButton';
