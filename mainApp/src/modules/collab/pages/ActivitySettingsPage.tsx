...
import { ArrowLeft, Activity, Check, Clock, Mail, Trash2 } from 'lucide-react';
      ...
      <header className="sticky top-0 z-20 bg-surface-950/80 backdrop-blur-xl border-b border-surface-800/60">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate(`/collab/${workspaceId}/activity`)}
            ...
            <div>
              <h1 className="font-display font-bold text-sm leading-none text-surface-50">Activity Settings</h1>
            </div>
          </div>
          <AnimatePresence>
            {saved && (
