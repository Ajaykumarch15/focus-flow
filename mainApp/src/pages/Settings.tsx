...
function NotificationSettingsSection({ onSaved }: { onSaved: () => void }) {
  ...
  const handleEnableAll = async () => {
    ...
    if (granted) {
      saveNotificationSettings({ enabled: true, deadlineReminders: true, pomodoroAlerts: true, habitReminders: true, dailyGoalReminder: true });
      onSaved();
      window.location.reload();
    }
  };
