...
import {
  ...
  Settings, Zap, Clock, ChevronLeft, ChevronRight, Target
} from 'lucide-react';
            ...
            {({ isActive }) => (
              <>
                ...
                {isActive && (
                  <motion.div
                    layoutId="activeNav"
                    className="absolute inset-0 rounded-xl bg-brand-500/10 -z-10"
                  />
                )}
              </>
            )}
          ...
          <AnimatePresence>
            {!collapsed && (
              ...
              >
                ...
                <p className="text-xs text-surface-300">Pro Plan</p>
              </motion.div>
            )}
          </AnimatePresence>
        </div>
