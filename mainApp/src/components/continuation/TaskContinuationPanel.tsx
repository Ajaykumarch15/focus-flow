...
import { selectTaskContinuation, type StoppedWhere } from '../../lib/continuationSelectors';
import { Button } from '../ui/Button';
import { StatusBadge } from '../ui/StatusBadge';
import { Skeleton } from '../ui/Skeleton';
import { formatHours, formatRelativeTime } from '../../utils/time';
      ...
      <div className="rounded-2xl border border-surface-800 bg-surface-900 p-5 flex flex-col gap-4">
        ...
        {view.hasActiveSession && (
          <div className="rounded-xl border border-surface-800/60 bg-surface-950/40 px-4 py-3 flex items-center gap-3">
            ...
            <Button variant="ghost" size="xs" className="ml-auto flex-shrink-0" onClick={() => navigate('/focus')}>
              Resume in Focus
            </Button>
          </div>
        )}
              ...
              <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
                ...
                {view.workLog && (
                  <Button
                    ...
                    onClick={() => navigate(`/worklog/${view.workLog!.id}`)}
                  >
                    Open work log
                  </Button>
                )}
